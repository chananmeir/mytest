...
UNDERWEAR_ITEMS = {
    ...
    'bra_standard_white': ClothingItem(
        ...
        category='underwear',
        slot='bra',
        image_path='underwear/bra_standard_white.png',
    ...
    'bra_lace_black': ClothingItem(
        ...
        category='underwear',
        slot='bra',
        image_path='underwear/bra_lace_black.png',
    ...
    'bra_sports': ClothingItem(
        ...
        category='underwear',
        slot='bra',
        image_path='underwear/bra_sports.png',
    ...
    'panties_standard_white': ClothingItem(
        ...
        category='underwear',
        slot='panties',
        image_path='underwear/panties_standard_white.png',
    ...
    'panties_lace_black': ClothingItem(
        ...
        category='underwear',
        slot='panties',
        image_path='underwear/panties_lace_black.png',
    ...
    'panties_thong': ClothingItem(
        ...
        category='underwear',
        slot='panties',
        image_path='underwear/panties_thong.png',
...
TOPS_ITEMS = {
    'blouse_white': ClothingItem(
        ...
        category='tops',
        slot='top',
        image_path='tops/blouse_white.png',
    ...
    'blouse_sheer': ClothingItem(
        ...
        category='tops',
        slot='top',
        image_path='tops/blouse_sheer.png',
    ...
    't_shirt_casual': ClothingItem(
        ...
        category='tops',
        slot='top',
        image_path='tops/t_shirt_casual.png',
    ...
    'sweater_modest': ClothingItem(
        ...
        category='tops',
        slot='top',
        image_path='tops/sweater_modest.png',
...
BOTTOMS_ITEMS = {
    'skirt_pencil': ClothingItem(
        ...
        category='bottoms',
        slot='bottom',
        image_path='bottoms/skirt_pencil.png',
    ...
    'skirt_mini': ClothingItem(
        ...
        category='bottoms',
        slot='bottom',
        image_path='bottoms/skirt_mini.png',
    ...
    'pants_slacks': ClothingItem(
        ...
        category='bottoms',
        slot='bottom',
        image_path='bottoms/pants_slacks.png',
    ...
    'jeans_casual': ClothingItem(
        ...
        category='bottoms',
        slot='bottom',
        image_path='bottoms/jeans_casual.png',
    ...
    'shorts_athletic': ClothingItem(
        ...
        category='bottoms',
        slot='bottom',
        image_path='bottoms/shorts_athletic.png',
    ...
    'leggings_yoga': ClothingItem(
        ...
        category='bottoms',
        slot='bottom',
        image_path='bottoms/leggings_yoga.png',
...
DRESSES_ITEMS = {
    'dress_modest_floral': ClothingItem(
        ...
        category='dresses',
        slot='dress',
        image_path='dresses/dress_modest_floral.png',
    ...
    'dress_cocktail': ClothingItem(
        ...
        category='dresses',
        slot='dress',
        image_path='dresses/dress_cocktail.png',
    ...
    'dress_sundress': ClothingItem(
        ...
        category='dresses',
        slot='dress',
        image_path='dresses/dress_sundress.png',
